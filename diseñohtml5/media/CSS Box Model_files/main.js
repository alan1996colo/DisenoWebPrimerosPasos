...
TopNavBar._highlightNetworkSubNavActiveLinks = function () {
  ...
  if (subdomain.startsWith('spaces')) {
...
TopNavBar._hideNetworkVideosLinkShiningStars = function () {
  ...
  var videosLinkElm = TopNavBar.element.querySelector('#videos-link');

  if (videosLinkElm) {
    videosLinkElm.querySelector('.shining-stars').classList.add('w3-hide');
  }
}
...
TopNavBar._showNetworkVideosLinkShiningStars = function () {
  ...
  if (videosLinkElm) {
    videosLinkElm.querySelector('.shining-stars').classList.remove('w3-hide');
  }
}

TopNavBar._applyNoUpsellUiTweaks = function () {
  var campusLinkElm = TopNavBar.element.querySelector('#campus-link');

  if (campusLinkElm) {
    campusLinkElm.style.display = 'none';
  }

  var billingLinkElm = TopNavBar.element.querySelector('#billing-link');

  if (billingLinkElm) {
    billingLinkElm.style.display = 'none';
  }
